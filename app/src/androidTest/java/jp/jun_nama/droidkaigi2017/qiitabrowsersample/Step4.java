...
import jp.jun_nama.espresso.commons.RxEspressoTestRunner;
...
public class Step4 {
    ...
    @Test
    public void test_fav_on() throws Exception {
        goArticleList();
        toggleFavStatus(13);
        assertFavStatus(13, true);
    }

    @Test
    public void test_fav_off() throws Exception {
        goArticleList();
        toggleFavStatus(13);
        toggleFavStatus(13);
        assertFavStatus(13, false);
    }

    @Test
    public void test_fav_list() throws Exception {
        goFavsList();
        assertItemDoesntExist(0);
